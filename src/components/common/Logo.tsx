  ...
  return (
    <div className={cn("flex items-center group cursor-pointer", className)}>
      ...
      <div className="relative mr-3">
        ...
        <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-primary via-primary-glow to-accent flex items-center justify-center logo-glow group-hover:scale-110 transition-all duration-300 shadow-xl">
          <div className="w-5 h-5 bg-white rounded-lg transform rotate-45 shadow-lg relative">
            <div className="absolute inset-1 bg-gradient-to-br from-primary/20 to-accent/20 rounded-sm"></div>
          </div>
        </div>
        
        {/* Premium Glow Ring */}
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-primary/20 to-accent/20 blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10"></div>
        
        {/* Status Indicator */}
        <div className="absolute -top-1 -right-1 flex items-center justify-center">
          <div className="w-4 h-4 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full animate-pulse shadow-lg flex items-center justify-center">
