    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        <button
          ...
          className="w-14 h-14 bg-green-600 hover:bg-green-700 text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 animate-pulse"
        >
          {isOpen ? (
            <X className="w-6 h-6" />
          ) : (
